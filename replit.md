...
- **2026-03-05**: Exercise reorder within a day — expand any exercise card to see up/down arrow buttons; exercises can be moved up or down within the same training day; uses existing `reorderTasks` storage logic; first exercise hides up arrow, last hides down arrow
